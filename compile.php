...
<nav class="navbar navbar-inverse navbar-fixed-top nbar">
    <div class="navbar-header">
      <a class="navbar-brand lspace" href="index.php">Jatin's Online Compiler</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="space"><a href="#">Currently Supports ---></a></li>
      <li class="space"><a href="#">C</a></li>
      <li class="space"><a href="#">C++</a></li>
      <li class="space"><a href="#">Java</a></li>
